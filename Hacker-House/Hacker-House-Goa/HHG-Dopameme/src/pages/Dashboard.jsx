  ...
  return (
    <div className="flex overflow-hidden flex-col   pt-5 bg-slate-950 pb-[0px] max-md:pb-24">
      ...
      <div className="flex flex-col  ml-10 w-full  max-md:max-w-full">
        ...
        <div className="flex items-center flex-wrap gap-5 mt-32 mx-auto  text-2xl font-medium text-orange-600 uppercase max-md:mt-10 max-md:mr-2.5">
          <Reveal>
          ...
          <div className="flex gap-2 items-center justify-center my-auto  max-md:max-w-full">
      ...
      <div className="flex flex-col px-10 mt-8 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex flex-wrap gap-4">
          ...
          <RevealImg>
        <div className="flex  bg-black overflow-hidden w-full flex-col mt-36 font-semibold rounded-xl max-md:mt-10 max-md:max-w-full">
